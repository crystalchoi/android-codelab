...
class OfflineFlightRepository(
    ...
    override fun getAirportName(name: String): Flow<List<Airport>> = airportDao.getAirportName(name)
    ...
    override fun getFavoriteCode(code: String): Flow<List<Favorite>> = favoriteDao.getFavoriteCode(code)
